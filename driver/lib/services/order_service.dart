...
class OrderService {
  ...
  static Future get_one(int id) async {
   ...
   static Future create(Order order) async {
    ...
    var token = (await AuthService.getToken())['token'];
    var new_order = order.toJson();
    var req = await client.put(Uri.parse(baseUrl + "order/" + order.id.toString() + '/'),
        headers: {'Authorization': 'JWT $token'},
        body: new_order);
    ...
    var req = await client.delete(Uri.parse(baseUrl + "order/"  + order.id.toString() + '/'),
        headers: {'Authorization': 'JWT $token'},
        body: new_item);
    ...
    var token = (await AuthService.getToken())['token'];
    var new_item = order.toJson();
    var req = await client.patch(Uri.parse(baseUrl + "order/"  + order.id.toString() + '/'),
        headers: {'Authorization': 'JWT $token'},
        body: new_item);
